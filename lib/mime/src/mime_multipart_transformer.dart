...
class MimeMultipartTransformer extends StreamTransformerBase<List<int>, MimeMultipart> {
  ...
  MimeMultipartTransformer(String boundary) : _boundary = _getBoundary(boundary);

  @override
  Stream<MimeMultipart> bind(Stream<List<int>> stream) => BoundMultipartStream(_boundary, stream).stream;
}
